...
import imageSprLessonBuilderDarkLarge from '~/assets/image.png';
import imageSprLessonBuilderDarkPlaceholder from '~/assets/image.png';
import imageSprLessonBuilderDark from '~/assets/image.png';
        ...
        <ProjectSection padding="top">
          <ProjectSectionContent>
            <ProjectTextRow>
              ...
              <ProjectSectionText>
                L’objectif de ce projet était de concevoir une plateforme permettant aux enseignants de créer et gérer des QCM interactifs pour leurs étudiants. 
                Le site devait offrir une interface intuitive et permettre une correction automatisée des réponses.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
    ...
    />
        ...
        <ProjectTextRow>
          <ProjectSectionContent>
            <ProjectSectionText>
              <ul>
                <li><strong>Backend :</strong> Symfony et PHP pour gérer les utilisateurs, les questions et les résultats.</li>
                <li><strong>Frontend :</strong> HTML et CSS pour une interface utilisateur simple et efficace.</li>
                <li><strong>Intelligence Artificielle :</strong> Intégration d’un chatbot interactif avec l’API OpenAI pour assister les étudiants.</li>
                <li><strong>Gestion de projet :</strong> Suivi et collaboration via GitHub.</li>
              </ul>
            </ProjectSectionText>
          </ProjectSectionContent>
        </ProjectTextRow>
        ...
        <ProjectSection>
          <ProjectSectionContent>
            <ProjectTextRow>
              <ProjectSectionHeading>Développement du Chatbot OpenAI</ProjectSectionHeading>
              <ProjectSectionText>
                Une des fonctionnalités innovantes de ce projet a été l'intégration d’un chatbot basé sur OpenAI. Ce chatbot aide les étudiants à comprendre certaines questions en reformulant les énoncés ou en donnant des explications simplifiées.
              </ProjectSectionText>
            </ProjectTextRow>
          </ProjectSectionContent>
        </ProjectSection>
        ...
        <ThemeProvider theme="dark" data-invert>
          ...
          >
            ...
            <ProjectTextRow center centerMobile noMargin>
              ...
              <ProjectSectionText>
                Ce projet a permis de développer une plateforme complète pour l’évaluation des étudiants, tout en intégrant des outils modernes comme OpenAI et GitHub pour améliorer l’expérience utilisateur et la gestion des résultats.
              </ProjectSectionText>
