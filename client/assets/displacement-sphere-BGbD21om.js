import{r,j as y}from"./jsx-runtime-DexIYAB0.js";import{u as R,a as L}from"./image-DBElf9pe.js";import{u as M,m as z,b as C}from"./heading-DW_Vg015.js";import{u as E}from"./useWindowSize-mzNSXuUf.js";import{h as I,W as q,l as j,P as D,a as A,p as G,U as F,q as U,M as V,c as k,d as T,D as H,b as W,r as N}from"./three-B_s0NcTJ.js";import{t as B}from"./throttle-BgiUmwhn.js";import{u as P}from"./use-spring-ChwznKHD.js";import"./components-D1Eb6D8q.js";import"./index-DI9_PPA7.js";const O=`#define PHONG\r
\r
...
`,Y="_canvas_1pqfq_1",J={canvas:Y},h={stiffness:30,damping:20,mass:2},on=w=>{const{theme:u}=R(),b=r.useRef(Date.now()),m=r.useRef(),S=r.useRef(),c=r.useRef(),o=r.useRef(),a=r.useRef(),d=r.useRef(),g=r.useRef(),p=r.useRef(),x=r.useRef(),t=r.useRef(),s=M(),l=L(m),_=E(),f=P(0,h),v=P(0,h);return r.useEffect(()=>{const{innerWidth:n,innerHeight:e}=window;return S.current=new I(.8,.5),c.current=new q({canvas:m.current,antialias:!1,alpha:!0,powerPreference:"high-performance",failIfMajorPerformanceCaveat:!0}),c.current.setSize(n,e),c.current.setPixelRatio(1),c.current.outputColorSpace=j,o.current=new D(54,n/e,.1,100),o.current.position.z=52,a.current=new A,p.current=new G,p.current.onBeforeCompile=i=>{g.current=F.merge([i.uniforms,{time:{type:"f",value:0}}]),i.uniforms=g.current,i.vertexShader=X,i.fragmentShader=O},r.startTransition(()=>{x.current=new U(32,128,128),t.current=new V(x.current,p.current),t.current.position.z=0,t.current.modifier=Math.random(),a.current.add(t.current)}),()=>{k(a.current),T(c.current)}},[]),r.useEffect(()=>{const n=new H(16777215,u==="light"?1.8:2),e=new W(16777215,u==="light"?2.7:.4);return n.position.z=200,n.position.x=100,n.position.y=100,d.current=[n,e],d.current.forEach(i=>a.current.add(i)),()=>{N(d.current)}},[u]),r.useEffect(()=>{const{width:n,height:e}=_,i=e+e*.3;c.current.setSize(n,i),o.current.aspect=n/i,o.current.updateProjectionMatrix(),s&&c.current.render(a.current,o.current),n<=z.mobile?(t.current.position.x=14,t.current.position.y=10):n<=z.tablet?(t.current.position.x=18,t.current.position.y=14):(t.current.position.x=22,t.current.position.y=16)},[s,_]),r.useEffect(()=>{const n=B(e=>{const i={x:e.clientX/window.innerWidth,y:e.clientY/window.innerHeight};f.set(i.y/2),v.set(i.x/2)},100);return!s&&l&&window.addEventListener("mousemove",n),()=>{window.removeEventListener("mousemove",n)}},[l,s,f,v]),r.useEffect(()=>{let n;const e=()=>{n=requestAnimationFrame(e),g.current!==void 0&&(g.current.time.value=5e-5*(Date.now()-b.current)),t.current.rotation.z+=.001,t.current.rotation.x=f.get(),t.current.rotation.y=v.get(),c.current.render(a.current,o.current)};return!s&&l?e():c.current.render(a.current,o.current),()=>{cancelAnimationFrame(n)}},[l,s,f,v]),y.jsx(C,{in:!0,timeout:3e3,nodeRef:m,children:({visible:n,nodeRef:e})=>y.jsx("canvas",{"aria-hidden":!0,className:J.canvas,"data-visible":n,ref:e,...w})})};export{on as DisplacementSphere};
